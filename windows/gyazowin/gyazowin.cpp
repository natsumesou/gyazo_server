...
TCHAR *szTitle			= _T("Nyazo+");		// タイトル バーのテキスト
TCHAR *szWindowClass	= _T("NYAZOWIN");	// メイン ウィンドウ クラス名
TCHAR *szWindowClassL	= _T("NYAZOWINL");	// レイヤー ウィンドウ クラス名
HWND hLayerWnd;
                     ...
                     int       nCmdShow)
{
	...
	g_Settings = loadSettings(_T("nyazowin+.ini"), _T("nyazowin+"));
...
//	const TCHAR* UPLOAD_PATH	= _T("/upload.cgi");
	...
	// User-Agentを指定
	const TCHAR* ua = _T("User-Agent: Nyazowin/1.0\r\n");
